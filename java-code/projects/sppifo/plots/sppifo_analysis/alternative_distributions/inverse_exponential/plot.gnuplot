...
set output 'projects/sppifo/plots/sppifo_analysis/alternative_distributions/inverse_exponential/inverse_exponential.pdf'
plot "projects/sppifo/plots/sppifo_analysis/alternative_distributions/inverse_exponential/inverse_exponential.dat" using 4 title "Greedy (optimal)" w l ls 9 lw 6, \
