...
plot "projects/sppifo/plots/sppifo_evaluation/pFabric/data_mining_workload/pFabric_less_100KB_99th_fct_ms.dat" using 4 title "PIFO" w lp  ls 21 lw 4, \
            ...
            '' using 2 title "Drop-Tail"  w lp ls 28 lw 4
set key on
...
set ytics auto
set key opaque
plot "projects/sppifo/plots/sppifo_evaluation/pFabric/data_mining_workload/pFabric_geq_1MB_mean_fct_ms.dat" using 4 title "PIFO (pFabric)" w lp  ls 21 lw 4, \
            '' using 5 title "SP-PIFO (pFabric)"  w lp ls 23 lw 4, \
            '' using 2 title "Drop-Tail"  w lp ls 28 lw 4
